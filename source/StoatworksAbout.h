/*
 * Stoatworks Labs - About window data for Outrun.
 *
...
{
    inline constexpr auto name = "Outrun";
    inline constexpr auto slug = "outrun";
    inline constexpr auto hook = "Breakaway neon strokes for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/outrun/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/outrun/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/outrun";
