...
/**
    ...
    parameters. The Edge group is deliberately left alone -- sensitivity and
    detail are tuned to the operator's artwork, and a preset that undid that
    tuning every time it was picked would cost more than it gave. Mix and
    Phase stay the operator's too. Both variants share the table: a source
    preset simply has nothing to say about edges, and an effect preset ignores
    the Path group it carries.
*/
...
// Option values are element indices: Path is the Path enum (0 Grid,
...
inline constexpr Preset kPresets[] = {
	...
	{ "Outrun Grid",
	  { /*Path*/ 0, /*Scale*/ 0.5f, /*Detail*/ 0.4f, /*Horizon*/ 0.5f,
	...
	{ "Laser Tunnel",
	  { /*Path*/ 5, /*Scale*/ 0.6f, /*Detail*/ 0.5f, /*Horizon*/ 0.5f,
	...
	{ "Oscilloscope",
	  { /*Path*/ 7, /*Scale*/ 0.7f, /*Detail*/ 0.4f, /*Horizon*/ 0.5f,
	    /*Width*/ 0.3f, /*Core*/ 0.6f, /*Trace*/ 1, /*TAngle*/ 0.0f,
	    /*BreakMode*/ 0, /*Amount*/ 0.0f, /*BSpread*/ 0.4f, /*BHue*/ 0.15f,
	...
	{ "Circuit Pulse",
	  { /*Path*/ 3, /*Scale*/ 0.5f, /*Detail*/ 0.55f, /*Horizon*/ 0.5f,
