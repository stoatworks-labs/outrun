# Running unsigned Outrun builds
...
```sh
xattr -dr com.apple.quarantine "$HOME/Documents/Resolume Arena/Extra Effects/Outrun.bundle"
```
...
```sh
codesign --force --deep --sign - "$HOME/Documents/Resolume Arena/Extra Effects/Outrun.bundle"
```

Verify it took:

```sh
codesign -dv --verbose=4 "$HOME/Documents/Resolume Arena/Extra Effects/Outrun.bundle"
spctl -a -vv "$HOME/Documents/Resolume Arena/Extra Effects/Outrun.bundle"   # still reports "rejected" — ad-hoc is not notarization
```
